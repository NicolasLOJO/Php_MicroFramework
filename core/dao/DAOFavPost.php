...
class DAOFavPost extends DAO{
    ...
    public function retrieve($id){
        //retourne entité
        $qb = new Query();
        $sql = $qb->table("favPost")->select("*")->where("id = $id")->getQuery();
        $value = $qb->getValue();
        var_dump($sql);
        $db = $this->pdo;
        $rep = $db->prepare($sql);
    ...
    public function update($entity, $id){
        $qb = new Query();
        $sql = $qb->table("favPost")->update($entity)->where("id = $id")->getQuery();
        $value = $qb->getValue();
        $db = $this->pdo;
        $req = $db->prepare($sql);
    ...
    public function delete($id){
        $qb = new Query();
        $sql = $qb->table("favPost")->delete()->where("id = $id")->getQuery();
        $value = $qb->getValue();
        $db = $this->pdo;
        $req = $db->prepare($sql);
        return $req->execute($value);
    ...
    public function create($array_assoc){
        //retourne entité
        $qb = new Query();
        $sql = $qb->table("favPost")->insert($array_assoc)->getQuery();
        $value = $qb->getValue();
        $db = $this->pdo;
        $req = $db->prepare($sql);
        $req->execute($value);
    ...
    public function getAllBy($array_assoc){
        ...
        $qb = new Query();
        $sql = $qb->table("favPost")->select('*')->where($array_assoc)->getQuery();
        $value = $qb->getValue();
        $db = $this->pdo;
        $req = $db->prepare($sql);
        $req->execute($value);
    ...
    public function getAll(){
        $qb = new Query();
        $sql = $qb->table("favPost")->select('*')->getQuery();
        $db = $this->pdo;
        $rep = $db->query($sql);
